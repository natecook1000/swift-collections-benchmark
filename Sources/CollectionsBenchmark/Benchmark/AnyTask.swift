...
public struct AnyTask {
  ...
  public func prepare(input: Any) async -> ((inout Timer) async -> Void)? {
    await _box.prepare(input: input)
  }
...
internal class _AnyTask {
  ...
  func prepare(input: Any) async -> ((inout Timer) async -> Void)? {
